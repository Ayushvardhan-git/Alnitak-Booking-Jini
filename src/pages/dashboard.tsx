...
import { CalendarIcon, ImageIcon, ShareIcon, TrendingUpIcon, PlusIcon } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-border p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mt-1">{DEMO_STATS.posts}</h3>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-border p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mt-1">{DEMO_STATS.impressions}</h3>
              </div>
              <div className="p-2 bg-blue-50 rounded-lg">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-border p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mt-1">{DEMO_STATS.engagement}</h3>
              </div>
              <div className="p-2 bg-blue-50 rounded-lg">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-border p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-gray-500">Website Clicks</p>
                <h3 className="text-2xl font-bold text-gray-900 mt-1">{DEMO_STATS.clicks}</h3>
              </div>
              <div className="p-2 bg-blue-50 rounded-lg">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm border border-border overflow-hidden">
              <div className="px-6 py-4 border-b border-border flex justify-between items-center">
                ...
                <Link to="/posts" className="text-sm font-medium text-primary hover:text-primary/80">
                  View all
                </Link>
              </div>
          ...
          <div>
            <div className="bg-white rounded-xl shadow-sm border border-border overflow-hidden">
              <div className="px-6 py-4 border-b border-border">
                <h2 className="text-lg font-semibold text-gray-900">Upcoming Occasions</h2>
              </div>
              <div className="divide-y divide-border">
                {DEMO_UPCOMING_OCCASIONS.map(occasion => (
                  <div key={occasion.id} className="p-4 hover:bg-gray-50">
                    ...
                    <p className="mt-1 text-xs text-gray-500">{occasion.description}</p>
                    <div className="mt-3">
                      <Link
                        to={`/create?occasion=${encodeURIComponent(occasion.name)}`}
